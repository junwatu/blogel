...
/***/ function(module, exports, __webpack_require__) {
	...
	var _t3js = __webpack_require__(1);
	
	var _t3js2 = _interopRequireDefault(_t3js);
	
	var _mediumEditor = __webpack_require__(2);
	...
	var service = _t3js2.default.Application.getService('post');
	var idStatus = document.getElementById('status');
	
	window.editor = new _mediumEditor2.default(document.querySelectorAll('.editable'), {
	  toolbar: {
	...
	_t3js2.default.Application.init({
	  debug: true
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! t3-native v2.0.2 */
	/*!
...
/***/ function(module, exports, __webpack_require__) {
	...
	_t3js2.default.Application.addModule('navigation', function (context) {
	
	  var editorInst = undefined,
	      service = undefined;
	
	  function onSavePost() {
	    var content = editorInst.serialize();
	    var post_content = {
	      post: {
	        title: content['element-0'],
	        content: content['element-1'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	_t3js2.default.Application.addService('post', function (application) {
